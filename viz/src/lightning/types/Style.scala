...
case class Label(label: List[Int]) extends Style {
...
case class Value(value: List[Double]) extends Style {
...
case class Alpha(alpha: List[Double]) extends Style {
...
case class Size(size: List[Double]) extends Style {
